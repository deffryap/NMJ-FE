...
const ContactHero = () => {
  return (
    <section
      className="relative w-full min-h-[220px] md:min-h-[320px] flex flex-col justify-center items-center text-center overflow-hidden"
      style={{
        backgroundImage: "url('/gambar.png')", // Ganti dengan gambar latar yang sesuai

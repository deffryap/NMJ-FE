...
const InfoCard = () => {
  return (
    <div className="flex justify-center lg:justify-end w-full px-4 sm:px-6 lg:px-0 mt-[-2rem] sm:mt-[-2.5rem] mb-6 sm:mb-8 relative z-20">
      <div className="bg-[var(--nmj-red)] text-white shadow-lg flex flex-col sm:flex-row items-center gap-4 sm:gap-6 px-6 sm:px-8 py-4 w-full max-w-sm">
        <div className="flex items-center flex-col gap-2">
          <Building className="w-8 h-8 text-[var(--nmj-red)]" />
        ...
        <div className="flex gap-2 flex-col items-center sm:items-start">
          <PhoneIcon className="w-8 h-8 text-[var(--nmj-red)]" />
          <div className="text-center sm:text-left text-white">

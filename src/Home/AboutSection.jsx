...
const AboutSection = () => {
  return (
    <section className="w-full bg-[var(--nmj-college)] py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-10 flex flex-col items-center">
      <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
        ...
        <div className="flex-1 pr-0 sm:pr-4 md:pr-8 lg:pr-12 xl:pr-16 flex flex-col justify-center order-1 lg:order-2">
          <h2
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 leading-tight text-center lg:text-left"
            data-aos="fade-up"
            data-aos-delay="200"
          >
          ...
          <p
            className="text-white text-xs sm:text-sm md:text-base mb-4 sm:mb-6 md:mb-8 max-w-xl text-center lg:text-left"
            data-aos="fade-up"
            data-aos-delay="300"
          >
          ...
          <button
            className="mt-2 text-white font-bold border-b-2 border-[var(--nmj-red)] hover:text-[var(--nmj-red)] transition w-max px-0 py-1 rounded-none shadow-none text-xs sm:text-sm md:text-base mx-auto lg:mx-0"
            data-aos="fade-up"
            data-aos-delay="700"
          >
            TENTANG KAMI

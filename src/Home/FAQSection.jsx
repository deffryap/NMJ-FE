...
function Accordion({ data, baseDelay = 400 }) {
    ...
    <div>
      {data.map((item, i) => (
        <div
          ...
          data-aos="fade-up"
          data-aos-delay={baseDelay + i * 100}
        >
          <button
...
const FAQSection = () => {
  ...
  return (
    <section className="w-full flex flex-col lg:flex-row items-stretch bg-[var(--nmj-college)] px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-stretch">
        {/* LEFT: FAQ */}
        <div className="flex-1 max-w-xl flex flex-col bg-[var(--nmj-college)] px-0 py-8 sm:py-10 md:py-12 lg:py-14 justify-between relative z-10 border-r border-[var(--nmj-morning)]">
          <div className="flex flex-col justify-center text-white w-full lg:w-1/2 h-full min-h-0 px-0 sm:px-2 md:px-2 lg:px-4 xl:px-6 py-0 sm:py-2 md:py-4 lg:py-6">
            <div
              className="text-[var(--nmj-red)] text-xs sm:text-sm font-semibold mb-2 sm:mb-3"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              FAQ
            ...
            <h2
              className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 md:mb-8 leading-tight"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              Pertanyaan
            ...
            <button
              className="bg-[var(--nmj-red)] text-white px-4 sm:px-6 py-2 sm:py-3 font-semibold shadow hover:bg-[var(--nmj-red)] transition mb-6 sm:mb-8 md:mb-10 text-sm sm:text-base"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              Tanya Sekarang
        ...
        <div className="flex-[1.5] flex flex-col bg-[var(--nmj-morning)] px-0 py-0">
          <div className="bg-[var(--nmj-morning)] rounded-none shadow-none px-4 sm:px-6 md:px-6 lg:px-8 xl:px-12 pt-8 sm:pt-10 md:pt-12 lg:pt-14 pb-2 border-b border-gray-100 h-full flex flex-col justify-start">
            <div className="flex flex-col gap-3 sm:gap-4">
              <Accordion data={data} baseDelay={400} />
            </div>
          </div>
        </div>
      </div>
